...
class NewHighScoreScreen extends StatefulWidget {
  const NewHighScoreScreen({Key? key}) : super(key: key);

  @override
  State<NewHighScoreScreen> createState() => _NewHighScoreScreenState();
}

class _NewHighScoreScreenState extends State<NewHighScoreScreen> {
  @override
  ...
  Container buildScoreContainer(int place) {
    NumberColor numberColor = NumberColor.tan;
